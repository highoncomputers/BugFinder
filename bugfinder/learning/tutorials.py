...
XSS_TUTORIAL = _tutorial(Tutorial(
    id="xss",
...
SQLI_TUTORIAL = _tutorial(Tutorial(
    id="sqli",
    title="SQL Injection",
...
SSRF_TUTORIAL = _tutorial(Tutorial(
    id="ssrf",
...
AUTH_TUTORIAL = _tutorial(Tutorial(
...
API_TUTORIAL = _tutorial(Tutorial(
    id="api-testing",
...
CORS_TUTORIAL = _tutorial(Tutorial(
    id="cors-misconfig",
...
FILE_UPLOAD_TUTORIAL = _tutorial(Tutorial(
    id="file-upload",
