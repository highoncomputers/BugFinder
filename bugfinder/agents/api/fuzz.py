...
class APIFuzzAgent(BaseAgent):
    ...
    async def execute(self, context: AgentContext) -> AgentResult:
        ...
        common_params = ["id", "page", "limit", "offset", "sort", "order", "filter", "search", "q", "debug", "test", "admin", "token", "key", "api_key", "secret", "password", "username", "email", "file", "path", "url", "callback", "redirect", "next", "format", "type", "action", "method", "function", "cmd", "command", "exec"]
