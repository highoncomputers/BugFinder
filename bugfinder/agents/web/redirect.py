...
class OpenRedirectAgent(BaseAgent):
    ...
    async def execute(self, context: AgentContext) -> AgentResult:
        ...
        redirect_params = ["redirect", "url", "next", "return", "return_to", "returnUrl", "r", "u", "to",
                           "dest", "destination", "goto", "target", "view", "page", "ref", "referer", "logout"]
                ...
                try:
                    ...
                    if status in (301, 302, 303, 307, 308) and "evil.com" in location:
                        findings.append({
                            ...
                            "cvss_score": 6.1,
                            "evidence": {"parameter": param, "test_url": test_url, "redirect_url": location, "status_code": status},
