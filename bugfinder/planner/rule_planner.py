...
TARGET_PLANS: dict[TargetType, list[dict]] = {
    TargetType.WEBSITE: [
        ...
        {"agent": "redteam.evasion", "rationale": "Detect WAF and generate evasive payloads"},
        {"agent": "redteam.data_exfil", "rationale": "Map data exfiltration paths"},
        {"agent": "redteam.pivot_scan", "rationale": "Scan internal network through pivot"},
    ],
    TargetType.API: [
        ...
        {"agent": "verification", "rationale": "Verify discovered findings"},
        {"agent": "redteam.priv_esc", "rationale": "Check privilege escalation vectors"},
        {"agent": "redteam.persistence", "rationale": "Generate persistence mechanisms"},
        {"agent": "redteam.c2_implant", "rationale": "Generate C2 implant payloads"},
        {"agent": "redteam.lateral_movement", "rationale": "Map lateral movement paths"},
    ],
    TargetType.ANDROID: [
